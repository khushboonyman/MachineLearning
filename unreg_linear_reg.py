# -*- coding: utf-8 -*-
"""
Created on Sun Nov  3 16:39:55 2019
...
for train_index, test_index in CV.split(X,y):
    ...
    print("here")
    my_res = y_train-X_train
    my_res2 = my_res @ w_rlr[:,k]
    my_res3 = np.square(my_res2).sum()
    my_res4 = my_res3 / y_train.shape[0]
    # Compute mean squared error with regularization with optimal lambda
    Error_train_rlr[k] = my_res4
    my_res5 = y_test-X_test @ w_rlr[:,k]
    my_res6 = np.square(my_res5).sum()
    Error_test_rlr[k] = my_res6/y_test.shape[0]
